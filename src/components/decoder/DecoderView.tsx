...
const DecoderView: React.FC = () => {
  ...
  return (
    <>
      {/* PageHeading */}
      <div className="mb-8">
        <h1 className="text-text-primary text-4xl font-black leading-tight tracking-[-0.033em]">Calldata Decoder</h1>
        <p className="text-text-secondary text-base font-normal leading-normal mt-2">
          Decode arbitrary calldata or transaction hashes from the Rootstock network.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-text-primary tracking-light text-2xl font-bold leading-tight">Input</h3>
        ...
        {/* Output Section */}
        <div className="flex flex-col gap-6">
          <h3 className="text-text-primary tracking-light text-2xl font-bold leading-tight">Output</h3>
          <div className="flex h-full min-h-[400px] flex-col rounded border border-border-color bg-surface p-6">
            {isDecoded ? (
              ...
              {/* Signature Card */}
              <div className="rounded border border-border-color bg-background p-4">
                <p className="font-mono text-sm text-text-secondary">Signature</p>
                <div className="flex items-center justify-between gap-2 mt-2">
                  <p className="font-mono text-base text-orange-400">0xa9059cbb</p>
                  <button className="text-text-secondary hover:text-text-primary transition-colors">
                    <span className="material-symbols-outlined">content_copy</span>
                  </button>
                </div>
              ...
              <div className="mt-2">
                ...
                <div className="mt-4 flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-[1fr_2fr] items-start gap-4 rounded border border-border-color bg-background p-4">
                    <div className="flex flex-col">
                      <p className="font-mono text-sm text-text-secondary">Parameter</p>
                      <p className="font-mono text-base text-purple-400 mt-1">to</p>
                    </div>
                    <div className="flex flex-col">
                  ...
                  <div className="grid grid-cols-[1fr_2fr] items-start gap-4 rounded border border-border-color bg-background p-4">
                    <div className="flex flex-col">
                      <p className="font-mono text-sm text-text-secondary">Parameter</p>
                      <p className="font-mono text-base text-purple-400 mt-1">amount</p>
                    </div>
                    <div className="flex flex-col">
                      <p className="font-mono text-sm text-text-secondary">
