...
- [ ] T029 [US1] Update the main application navigation to include links to all the new pages.
- [ ] T030 [US1] Perform a full visual review of all new pages, comparing them against the `screen.png` files in `ui-design-files`.
- [ ] T031 Run the linter (`npm run lint`) and formatter (`npm run format`) across the entire project to ensure code quality.
- [ ] T032 Run all project tests (`npm run test`) to ensure no regressions were introduced.
